    ...
    while True:
        ...
        for i in range(len(boxes)):
            if i in indexes:
                ...
                print(".........................",path)
                q="insert into emergency values(null,'%s','Weaponn/Violenecedetect','0','0','pending')"%(branch_id)
                insert(q)



                q="insert into request values(null,'%s','request','%s','0','Forward To Police','Video')"%(branch_id,path)
                insert(q)
